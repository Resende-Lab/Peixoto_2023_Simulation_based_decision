########################################################################################
##### Advance breeding program - Conventional program plus HPT
#########################################################################################
...
F5_public.phen = setPheno(F5_public.s0,reps=1, p=pgye, H2=HTP_h2) # Fall
...
F3_public.phen = setPheno(F3_public.s0,reps=1, p=pgye, H2=HTP_h2) # Fall
...
F4_public.s0 = setPheno(F4_public.s0,reps=2*2, p=pgy, H2=HTP_h2) # Winter
